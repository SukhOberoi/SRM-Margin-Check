...
async function applyMagicToAcademiaPortal() {
    ...
    if (currentUrl.includes("#Page:My_Time_Table_2023_24")) {
        console.log("Applying magic to My Time Table 2023-24 page");
        const table = await waitForElement(
            "#zc-viewcontainer_My_Time_Table_2023_24 > div > div.cntdDiv > div > table.course_tbl",
        );
        ...
        console.log("Applying magic to My Attendance page");
